import { Box, Container, Separator, Text, VStack } from "@chakra-ui/react";
        ...
        <VStack gap={10} textAlign="center">
          ...
          <VStack gap={8}>
            ...
            <VStack gap={6} align="stretch">
              <Text fontSize="lg" color="gray.700" lineHeight="taller">
                ...
                learning become havens for children. Teachers not only hold
                space for learning – they also hold space for a wide range of
                emotions, thoughts, behaviours and personalities.
              </Text>
              ...
              <Text fontSize="lg" color="gray.700" lineHeight="taller">
                ...
                increase help-seeking behaviour in children. Emotional
                regulation works in a feedback loop – teachers affect children
                and children affect teachers. Co-regulation can therefore be
                profoundly helpful for everyone.
              </Text>
          ...
          <VStack gap={2}>
            ...
            <Text fontSize="md" color="teal.500">
              <a href="mailto:liprotheroe@gmail.com">liprotheroe@gmail.com</a>
            </Text>
          </VStack>
        </VStack>
      </Container>
